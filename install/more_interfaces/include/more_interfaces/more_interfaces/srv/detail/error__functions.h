...
#ifndef MORE_INTERFACES__SRV__DETAIL__ERROR__FUNCTIONS_H_
#define MORE_INTERFACES__SRV__DETAIL__ERROR__FUNCTIONS_H_
 ...
 * calls
 * more_interfaces__srv__Error_Request__init().
...
/**
 * It calls
 * more_interfaces__srv__Error_Request__fini()
 ...
 * more_interfaces__srv__Error_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * more_interfaces__srv__Error_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * more_interfaces__srv__Error_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_more_interfaces
...
/**
 * It calls
 * more_interfaces__srv__Error_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_more_interfaces
...
/**
 * It allocates the memory for the array and calls
 * more_interfaces__srv__Error_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_more_interfaces
...
/**
 * It calls
 * more_interfaces__srv__Error_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MORE_INTERFACES__SRV__DETAIL__ERROR__FUNCTIONS_H_
