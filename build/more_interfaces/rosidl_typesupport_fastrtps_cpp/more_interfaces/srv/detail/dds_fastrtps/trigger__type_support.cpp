...
#include "more_interfaces/srv/detail/trigger__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const more_interfaces::srv::Trigger_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  more_interfaces::srv::Trigger_Request & ros_message)
{
  // Member: trigger
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const more_interfaces::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<more_interfaces::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  return &more_interfaces::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, srv, Trigger_Request)() {
  return &more_interfaces::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_more_interfaces
cdr_serialize(
  const more_interfaces::srv::Trigger_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  more_interfaces::srv::Trigger_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const more_interfaces::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<more_interfaces::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &more_interfaces::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, srv, Trigger_Response)() {
  return &more_interfaces::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
{
  return &more_interfaces::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, srv, Trigger)() {
  return &more_interfaces::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
