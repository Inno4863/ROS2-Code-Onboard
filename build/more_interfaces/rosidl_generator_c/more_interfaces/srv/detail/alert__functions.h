...
#ifndef MORE_INTERFACES__SRV__DETAIL__ALERT__FUNCTIONS_H_
#define MORE_INTERFACES__SRV__DETAIL__ALERT__FUNCTIONS_H_
...
/// Create srv/Alert message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * more_interfaces__srv__Alert_Request__init().
...
/// Destroy srv/Alert message.
/**
 * It calls
 * more_interfaces__srv__Alert_Request__fini()
...
/// Check for srv/Alert message equality.
/**
...
/// Initialize array of srv/Alert messages.
/**
...
/// Finalize array of srv/Alert messages.
/**
 * It calls
 * more_interfaces__srv__Alert_Request__fini()
...
/// Create array of srv/Alert messages.
/**
 * It allocates the memory for the array and calls
 * more_interfaces__srv__Alert_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Alert messages.
/**
 * It calls
 * more_interfaces__srv__Alert_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Alert message array equality.
/**
...
/// Copy an array of srv/Alert messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * more_interfaces__srv__Alert_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_more_interfaces
...
/**
 * It calls
 * more_interfaces__srv__Alert_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_more_interfaces
...
/**
 * It allocates the memory for the array and calls
 * more_interfaces__srv__Alert_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_more_interfaces
...
/**
 * It calls
 * more_interfaces__srv__Alert_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MORE_INTERFACES__SRV__DETAIL__ALERT__FUNCTIONS_H_
