...
#include "more_interfaces/srv/detail/string__rosidl_typesupport_fastrtps_c.h"
...
using _String_Request__ros_msg_type = more_interfaces__srv__String_Request;
...
size_t get_serialized_size_more_interfaces__srv__String_Request(
  const void * untyped_ros_message,
...
static uint32_t _String_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_more_interfaces__srv__String_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t max_serialized_size_more_interfaces__srv__String_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _String_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_more_interfaces__srv__String_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, more_interfaces, srv, String_Request)() {
...
using _String_Response__ros_msg_type = more_interfaces__srv__String_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t get_serialized_size_more_interfaces__srv__String_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _String_Response__ros_msg_type * ros_message = static_cast<const _String_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_more_interfaces__srv__String_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t max_serialized_size_more_interfaces__srv__String_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _String_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_more_interfaces__srv__String_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, more_interfaces, srv, String_Response)() {
...
// already included above
// #include "more_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "more_interfaces/srv/string.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, more_interfaces, srv, String)() {
